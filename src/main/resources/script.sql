...
create table t_todo (id int8 generated by default as identity, created_at timestamp, updated_at timestamp, content varchar(255), name varchar(255), sort_order int8, primary key (id));
create table t_todo_detail (id int8 generated by default as identity, created_at timestamp, updated_at timestamp, content varchar(255), name varchar(255), sort_order int8, todo_id int8 not null, primary key (id));
